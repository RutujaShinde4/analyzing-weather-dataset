...
print("categorical variables in weather dataset",categorical(weather))
print("numerical variables in weather dataset",categorical(weather))
...
print("The number of times of the  weather was cloudy in 2012: ", clear(weather, 'Weather', 'Cloudy'))
